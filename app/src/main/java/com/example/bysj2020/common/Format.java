...
public final class Format {
    ...
    //月-日 时:分:秒
    public static final String MOUTH_DATE_TIME_CROSS_24="MM-dd HH:mm:ss";
    //月-日 时:分:秒
    public static final String MOUTH_DATE_TIME_CROSS_12="MM-dd hh:mm:ss";
    //月.日 时:分:秒
    public static final String MOUTH_DATE_TIME_POINT_24="MM.dd HH:mm:ss";
    //月.日 时:分:秒
    public static final String MOUTH_DATE_TIME_POINT_12="MM.dd hh:mm:ss";
    //月/日 时:分:秒
    public static final String MOUTH_DATE_TIME_SLASH_24="MM/dd HH:mm:ss";
    //月/日 时:分:秒
    public static final String MOUTH_DATE_TIME_SLASH_12="MM/dd hh:mm:ss";
    //年-月-日 时:分 格式
    public static final String DATE_HOUR_MINUTE_CROSS_24="yyyy-MM-dd HH:mm";
    //年-月-日 时:分 格式
    public static final String DATE_HOUR_MINUTE_CROSS_12="yyyy-MM-dd hh:mm";
    //年.月.日 时:分 格式
    ...
    //月-日 时:分 格式
    public static final String MOUTH_HOUR_MINUTE_CROSS_24="MM-dd HH:mm";
    //月-日 时:分 格式
    public static final String MOUTH_HOUR_MINUTE_CROSS_12="MM-dd hh:mm";
    //月.日 时:分 格式
    public static final String MOUTH_HOUR_MINUTE_POINT_24="MM.dd HH:mm";
    //月.日 时:分 格式
    public static final String MOUTH_HOUR_MINUTE_POINT_12="MM.dd hh:mm";
    //月/日 时:分 格式
    public static final String MOUTH_HOUR_MINUTE_SLASH_12="MM/dd hh:mm";
    //月/日 时:分 格式
    public static final String MOUTH_HOUR_MINUTE_SLASH_24="MM/dd HH:mm";
    //MM月dd日 HH时mm分
    public static final String MOUTH_HOUR_MINUTE_24="MM月dd日 HH时mm分";
    //MM月dd日 hh时mm分
    public static final String MOUTH_HOUR_MINUTE_12="MM月dd日 hh时mm分";
    ...
    //星期一
    public static final String HOUR_MINUTE_WEEK="EEEE";
    //hh:mm
